...
LIVOX_SDK_ROOT="${SYSTEM_INSTALL_ROOT}/vendor/livox_sdk2"
...
copy_lio_sam_mid360_overrides() {
  ...
  local override_files=(
    ...
    "LICENSE"
    "msg/CloudInfo.msg"
    "include/lio_sam/lidar_transform_cache.hpp"
    "include/lio_sam/multi_lidar_projection_types.hpp"
    "include/lio_sam/multi_lidar_scan_synchronizer.hpp"
